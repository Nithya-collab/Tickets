...
const switchVariants = tv({
  slots: {
    root: [
      ...
      // checked
      "data-[state=checked]:bg-gray-300 data-[state=checked]:dark:bg-sky-800",
      // disabled
...
>(({ className, size, ...props }: SwitchProps, forwardedRef) => {
  ...
  return (
    <SwitchPrimitives.Root
      ...
      {...props}
    >
      <SwitchPrimitives.Thumb className={cx(thumb())} asChild>
        <span className="-top-1">{ !props.defaultChecked ? "🔆":"🌙" }</span>
